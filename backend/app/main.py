...
def create_app(
    ...
    routes = [
        ...
        Route("/api/sources/{source_id}", sources.get_source),
        Route("/api/sources/{source_id}", sources.update_source, methods=["PUT"]),
        Route("/api/sources/{source_id}", sources.remove_source, methods=["DELETE"]),
