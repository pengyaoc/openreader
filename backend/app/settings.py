...
# Hard write-lock for PUT /api/config — set on the VM so the unauthenticated
# config-write endpoint can't be used to rewrite feeds.yaml (or flip
# llm.enabled back on) over the internet. Config edits go through SSH instead.
